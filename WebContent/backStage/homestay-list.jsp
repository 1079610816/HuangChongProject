...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">黄虫短租</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> <span class="logo navbar-slogan f-l mr-10 hidden-xs">v3.0</span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-picture">
			<dt class="selected"><i class="Hui-iconfont">&#xe613;</i> 民宿管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd style="display: block;">
				<ul>
					<li class="current"><a href="homestay-list.jsp" title="民宿列表">民宿列表</a></li>
				</ul>
			</dd>
		</dl>
...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 民宿管理 <span class="c-gray en">&gt;</span> 民宿列表<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<script>
  $(function(){
	 ...
	 //修改员工信息的超链接单击事件
	 $(document).on("click",'.homestayedit',function()
	 {
	    ...
	    // console.log(arr);
	     ...
	     layer.open({
	 		...
	 		shade:0.4,
	 		title: '编辑员工信息', //显示的标题
	 		content: 'homestay-edit.html', //很多种写法 其中之一直接写目标窗口(要弹出来窗口)
...
<script>
    ...
    employee.requestUrl = {
        queryList:employee.url+"HuangChongProject/hs.do?op=homestaylist"  //数据是从servlet一侧返回的 json格式
    };
