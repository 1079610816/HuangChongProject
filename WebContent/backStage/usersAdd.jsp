...
<body>
	<article class="cl pd-20">
		...
		<form action="../us.do?op=userAdd" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="file" accept="image/*" id="file" name="file" onChange="play()" /><br/>
					<img src="" id="img01" style="display: none;" width="100px" height="100px" />
				</div>
			</div>
			<div class="row cl">
