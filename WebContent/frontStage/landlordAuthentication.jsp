...
<link href="//staticnew.mayi.com/resourcesWeb/css/global.css"
	rel="stylesheet" type="text/css" />
<link
	href="//staticnew.mayi.com/resourcesWeb/css/PCenter.css?V=201310081852"
	rel="stylesheet" type="text/css" />
<link href="//staticnew.mayi.com/resourcesWeb/css/order.css"
	rel="stylesheet" type="text/css" />
<link href="//staticnew.mayi.com/resourcesWeb/css/default.css"
	rel="stylesheet" type="text/css" />
<link
	href="//staticnew.mayi.com/resourcesWeb/css/landlord/manage_pub.css"
	rel="stylesheet" type="text/css" />
<link
	href="//staticnew.mayi.com/resourcesWeb/ordernew/css/sesame_credit.css"
	rel="stylesheet" type="text/css" />
<!-- new header -->
<link
	href="//staticnew.mayi.com/resourcesWeb/v201510/css/public_element.css"
	rel="stylesheet" type="text/css">
<link href="//staticnew.mayi.com/resourcesWeb/ordernew/css/fdbx.css"
	rel="stylesheet" type="text/css">
<link href="//staticnew.mayi.com/resourcesWeb/ordernew/css/fdbx_add.css"
	rel="stylesheet" type="text/css">
<style type="text/css">
.alertFd {
	height: 100%;
...
.refuse_info_input label input {
	margin-top: -2px;
}

.refuse_info_input label {
	line-height: 35px
}
...
.refuse_info_input label.formCbx {
	line-height: 22px;
}
</style>
<title>房东-身份验证</title>
<script type="text/javascript"
	src="//staticnew.mayi.com/resourcesWeb/js/jquery-1.9.1.min.js"></script>
<script type="text/javascript"
...
<body>
	...
	<link
		...
		rel="stylesheet" type="text/css">
	<script type="text/javascript"
		src="//staticnew.mayi.com/resourcesWeb/js/searchlist/index_searchlist_public.js?V=20180704"></script>
	<script type="text/javascript"
		...
		<div class='head_cnt relave'>
			<ul class="nav_R asote nav_right">
				...
				<li style="margin-left: -100px;">
					<div class="showinfo">
						<a
							href="javascript:menufrozen(870177979,'/tenant/870177979/orders','user')"
							target="_self"><img
							src="https://i1.mayi.com/mayi57/M84/CP/NN/AUHL3K6R738JWQE3T59CJHZW99F9E8.jpg_35x35c.jpg"
							id="aaa" class="user_img"> <span class="name"
							id="head_nickname"></span></a>
						<div class="head_pop">
							<div class="pop_column">
								<p>
									<a
										href="javascript:menufrozen(870177979,'/tenant/870177979/orders','user')"
										target="_self" id="myorder" rel="nofollow"
										_mayi_rp="webaround|userinfo|order">我的订单</a>
								</p>
								<p>
									<a
										href="javascript:menufrozen(870177979,'/user/tenant/accountmanager','user')"
										target="_self" id="myorder" rel="nofollow" class="slideactive"
										_mayi_rp="webaround|userinfo|account">我的账户</a>
								</p>
								<p>
									<a
										href="javascript:menufrozen(870177979,'/user/tenant/mycollection','user')"
										target="_self" id="mycollect" rel="nofollow"
										_mayi_rp="webaround|userinfo|collection">我的收藏</a>
								</p>
								<p>
									<a
										href="javascript:menufrozen(870177979,'/user/tenant/msgmanager','user')"
										target="_self" id="mymsg" rel="nofollow"
										_mayi_rp="webaround|userinfo|inform">消息通知</a>
								</p>
								<p class="Invite_friends" _mayi_rp="webaround|userinfo|invite">邀请好友</p>
								<p class="textCt">
									<a href="javascript:void(0)" id="loginoutbut" target="_self"
										class="stclick" clicktag="1_6">退出登录</a>
								</p>
							</div>
						</div>
					</div>
	...
	//初始化样式展示
		...
		<div class="centerCon">
			...
			<div class="accountMt clearfix">
				<div class="tabCon" style="background-image:img/cute.png ">
								<ul class="userInfo">
									<li class="clearfix">
									</li>
									<li class="clearfix">
									...
									<li class="clearfix ">
										<span class="infoTitle">真&nbsp;实&nbsp;姓&nbsp;名 ：</span>
										<input type="text" name="realName" id="realName" class="personLargeInput"value="" >
									</li>
									<li class="clearfix">
										<span class="infoTitle">身&nbsp;份&nbsp;证&nbsp;号：</span>
...
<div id="cancleDiv" class="alert-box">
	...
	<div class="alert-title">
		拒绝订单 <a class="alert-close" href="javascript:void(0)" rel="nofollow"></a>
	</div>
	<div class="alert-con">
		<div class="removetext">你确定要拒绝订单吗？</div>
		<div class="btn-box">
			<input type="button" class="warn-btn" name="" value="确定"
				onclick="processOrder();"> <input type="button"
				id="cancleDivClose" class="gray-btn" name="" value="以后再说">
		</div>
	</div>
</div>
<!-- 取消订单 END -->
...
<div id="confirmDiv" class="alert-box">
	<div class="alert-title">
		确认订单 <a class="alert-close" href="javascript:void(0)" rel="nofollow"></a>
	</div>
	<div class="alert-con">
		<div class="removetext">你确定要确认订单吗？</div>
		<div class="btn-box">
			<input type="button" class="warn-btn" name="" value="确定"
				onclick="processOkOrder();"> <input type="button"
				id="confirmDivClose" class="gray-btn" name="" value="以后再说">
		</div>
	</div>
</div>
<!-- 确认订单 END -->
		...
		<div class="dp_daypicker" style="padding-top: 10px;">
			<form class="refuse_info_input">
				<label><input type="radio" name="state" value="0"
					class="no_room" />无房</label><br /> <label><input type="radio"
					name="state" value="1" class="no_gengxin" />蚂蚁上的房价未更新</label><br /> <label><input
					type="radio" name="state" value="2" />预订天数太少</label><br /> <label><input
					type="radio" name="state" value="3" />预订日期太远</label><br /> <label><input
					type="radio" name="state" value="5" />不符合本房源的接待要求</label><br /> <label><input
					type="radio" name="state" value="4" />房屋无法正常使用</label><br /> <label><input
					type="radio" name="state" value="6" />临时有事无法接待</label><br /> <label><input
					type="radio" name="state" value="7" />其他</label><br />

				<textarea class="t_area" id="reason" placeholder="具体说明（选填信息）"></textarea>
				<label id="changeFt" class="formCbx clearfloat">
					<!--<input type="checkbox" checked id="change_fangtai">-->
					<span id="fttext"></span>
				</label> <input type="button" value="拒绝订单" onclick="refuse_ok();"
					class="complete_success" /> <input type="button" value="取消"
					onclick="refuse_cancel();" class="complete_cancel">
			</form>
		</div>
	</div>
</div>
	...
	<div class="w1190 pb20 clearfloat">
		<div class="link_end">
			<p class="t-center f12 c777776">
				客户服务：500-065-6668 |<a href="http://www.mayi.com/tenantlogin/"
					target="_blank" class="c777776">&nbsp;帮助中心&nbsp;|</a><a
					href="http://www.mayi.com/aboutcompany/" target="_blank"
					class="c777776">&nbsp;公司信息&nbsp;|</a><a href="/sitemap"
					target="_blank" class="c777776">&nbsp;网站地图&nbsp;|</a><a
					href="http://www.mayi.com/activity/app50" target="_blank"
					class="c777776">&nbsp;app下载&nbsp;|</a>关注我们 <span
					class="mr10 cursorpt showinfo relave"
					style="display: inline-block; vertical-align: middle;"> <img
					src="//staticnew.mayi.com/resourcesWeb/images/weixin_logo_s.png">
					<img
					src="http://staticnew.mayi.com/resourcesWeb/v201510/images/index_own/weixin.jpg"
					class="head_pop absot" style="bottom: 24px; left: -32px;">
				</span> <span class="cursorpt"
					style="display: inline-block; vertical-align: middle;"> <img
					src="//staticnew.mayi.com/resourcesWeb/images/xinlang_logo_s.png"
					onclick="sinaWeibo();">
				</span>
			</p>
			<!--公司切换-->
			<p class="t-center f12 c777776">
				网站备案/许可证号：京ICP证130021号 <a class="c777776"
					href="https://i1.mayi.com/mayi41/M99/YJ/EZ/UFM6JS6W3CJCKVTKB7XZBH7QEPN4ZY.jpg"
					target="_blank">营业执照编号：102585576</a> 易云游网络技术（北京）有限公司
			</p>
