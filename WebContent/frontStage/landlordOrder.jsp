...
<c:if test="${orderLandlordList==null}">
	<c:redirect url="../ls.action?op=allLandlordOrders&userId=${user.userId }"></c:redirect>
</c:if>
...
<script type="text/javascript">
	...
	function searchOrder(state,op) {
		var url = "ls.action?op=" +op+ "&orderStatus="+state+"&userId="+${user.userId};
		window.location.href = url;
	}
	            	...
	            	<div class="showinfo" id="s_islandlord" >
	                	...
	                	<div class="head_pop">
		                	<div class="pop_column plr10">
		                        ...
		                        <p><a href="ls.action?op=allPublish&accomStatus=-1&userId=${user.userId }">房源管理</a></p>
...
<script>
	...
	<div class="main">
		...
		<ul class="breadcrumb clearfix">
			<li><a href="ls.action?op=allLandlordOrders&orderStatus=-1&userId=${user.userId }">我是房东</a> <span class="divider">》</span></li>
			<li>订单管理</li>  
		</ul>
		<input id="ownerId" type="hidden" value="870177979" />
		<div class="personalCenter clearfix">
         <ul class="center-sidebar">
			<li><a class="slideactive"  href="ls.action?op=allLandlordOrders&orderStatus=-1&userId=${user.userId }">订单管理<span class="ddgl_current" ></span></a></li>
		<li><a href="ls.action?op=allPublish&accomStatus=4&userId=${user.userId }">房源管理<span class="fygl" ></span></a></li>
